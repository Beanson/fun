    ...
    private function receiveEvent($object)
    {
        ...
        switch ($object->Event) {
            ...
            case "SCAN";{
                 ...
                 $course_id =$object->EventKey;
                 $content[]= array("Url" => "http://112.74.98.203/Intellectual_Campus_01/Application/index.php/Check_Name/CheckName/checkNameValidate?open_id=$open_id&course_id=$course_id");
                //$content = "http://intellectual-campus.cn-hangzhou.aliapp.com/intellectual_campus/index.php/Check_Name/CheckName/getCookie?open_id=$openid&course_id=$course_id";
            } break;

            case "scancode_push":     //一般会被SCAN覆盖掉，所以并没什么卵用
            ...
            case "CLICK": //事件类型是点击菜单,判断eventkey值
                switch ($object->EventKey) {
                    ...
                    case "personal_information"; {
                        $openid = $object->FromUserName;
                        $content[] = array("Title" => "个人信息",
                            "Description" => "关于个人信息的设置",
                            "PicUrl" => "http://p0.55tuanimg.com/static/goods/ckeditor/2012/08/30/20/ckeditor_1346331387_1979_wm.jpg",
                            "Url" => "http://112.74.98.203/Intellectual_Campus_01/Application/index.php/Check_Name/Student/studentRegister?open_id=$openid");
                    }
                        break;
                    ...
                    default:
                        $content = "receive a new eevent: " . $object->Event;
                        break;
                } break;

            default:
                $content="reveive a new event".$object->Eventkey;
        }
